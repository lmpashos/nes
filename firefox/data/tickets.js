...
function getTicketCount() {
	...
	var html =	"<thead>"+
					"<tr>"+
						"<th id=\"clickAtLoad\"><a href=\"javascript:void(0)\">Person</a></th>"+
						"<th><a href=\"javascript:void(0)\">Count</a></th>"+
						"<th><a href=\"javascript:void(0)\">Major</a></th>"+
						"<th><a href=\"javascript:void(0)\">Mod</a></th>"+
						"<th><a href=\"javascript:void(0)\">Info</a></th>"+
						"<th><a href=\"javascript:void(0)\">Callctr</a></th>"+
					"</tr>"+
				"</thead>"+
				"<tbody>";
	var count = 0;
	...
	html += "<tfoot><tr id=\"total\">" + "<td>" + "TOTAL" + "</td>" + "<td>" + numTickets + "</td>" + "<td>" + majorTotal + "</td>" + "<td>" + modTotal + "</td>" + "<td>" + infoTotal + "</td>" + "<td>" + inCallCenterTotal + "</td>" + "</tr></tfoot>"
	html += "</tbody>"
	self.port.emit("returnTicketCount",html);
}
